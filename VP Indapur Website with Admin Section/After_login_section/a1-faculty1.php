...
// 			echo "<script>location.href='After_login_section/a1-faculty1.php'</script>";
// 		}
// }
// else{
// 	echo "<script>location.href='After_login_section/a1-faculty1.php'</script>";
...
<div class="topimage">
	...
	<p id="h32"><span id="icons"><img src="IMG/call1.png"></span>02111-225602</p>
		...
		<div class="vertical-list">
			<table>
				<tr>
					<td><a href="academics1.php">Home</td>
				</tr>
				<tr>
		...
		<div class="homepage">
			<h1>Faculty:</h1>
			<h2>DUE TO USE OF DATABASE IN THIS FACULTY ITS MEAN WE NEED TO UPLOAD A FILE INTO OUR OWN DATABASE TO PROVIDE AN SUITABLE PDF.....</h2>
			<H1>SORRY ABOUT IT....BECUASE THIS PROJECT IS BASED ON ONLY HTML&CSS </H1>
		</div>
		<footer>
	<div class="singlecol">
		<h3>Contact Us </h3>
